...
function Pillars() {
  ...
  return <section id="wiedza" className="section-space"><div className="section-shell"><div className="reveal-up text-center"><SectionLabel>Pełny potencjał</SectionLabel><h2 className="display-title mx-auto max-w-4xl text-5xl md:text-8xl">Rozwój to więcej<br/>niż trening</h2></div>
...
function Programs() {
  return <section id="programy" className="bg-card section-space"><div className="section-shell"><div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-end"><div><SectionLabel>Wybierz kierunek</SectionLabel><h2 className="display-title text-6xl md:text-8xl">Programy<br/><span className="text-primary">treningowe</span></h2></div><p className="max-w-sm text-sm leading-7 text-muted-foreground">Każdy program zaczyna się od zrozumienia potrzeb zawodnika i może działać samodzielnie lub jako część dłuższego procesu.</p></div>
...
function Tailored() {
  ...
  return <section className="relative overflow-hidden section-space"><Network className="opacity-25"/><div className="section-shell relative"><SectionLabel>Trening szyty na miarę</SectionLabel><div className="grid gap-12 lg:grid-cols-[1.2fr_.8fr]"><h2 className="display-title text-6xl md:text-9xl">Każdy zawodnik<br/><span className="text-primary">jest inny</span></h2><div><p className="font-display text-4xl font-bold uppercase leading-none text-gold md:text-5xl">Nie gotowy schemat.<br/><span className="text-foreground">Indywidualny proces.</span></p><div className="mt-9">{differences.map((x,i)=><div key={x} className="flex items-center gap-4 border-b border-border py-4"><CircleDot className="size-4 text-primary"/><span className="font-display text-xl font-semibold uppercase">{x}</span><span className="ml-auto text-xs text-muted-foreground">0{i+1}</span></div>)}</div></div></div></div></section>;
}
